...
const StarwarsCard = props => {
    return (
        <Col sm="6" lg="4" key={props.name}>
            <Card style={{ background: "white", borderColor: "yellow" }}>
                <CardBody>
                    ...
                    <CardText className="text-muted">Skin Color: {props.skin_color}</CardText>
                    <CardText className="text-muted">Hair Color: {props.hair_color}</CardText>
